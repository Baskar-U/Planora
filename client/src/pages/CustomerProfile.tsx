              ...
              <CardContent className="space-y-4">
                ...
                <div className="text-center p-3 bg-purple-50 rounded-lg">
                  <div className="text-xl font-bold text-purple-600">
                    ₹{customerStats?.totalSpent?.toLocaleString() || 0}
                  </div>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                      ...
                      <div className="text-center p-4 bg-purple-50 rounded-lg">
                        <div className="text-2xl font-bold text-purple-600">{customerStats?.likedVendorsCount || 0}</div>
                        <p className="text-sm text-gray-600">Liked Vendors</p>
                      </div>
                      <div className="text-center p-4 bg-orange-50 rounded-lg">
                        <div className="text-2xl font-bold text-orange-600">₹{customerStats?.totalSpent?.toLocaleString() || 0}</div>
                        <p className="text-sm text-gray-600">Total Spent</p>
                      </div>
                    </div>
                        ...
                        customerStats.recentOrders.map((order: any) => (
                          <div key={order.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <p className="font-medium text-gray-900">{order.serviceDetails?.name || 'Service'}</p>
                            ...
                            <div className="text-right">
                              ...
                              <p className="text-sm font-medium text-gray-900 mt-1">₹{order.amount?.toLocaleString() || 0}</p>
                            </div>
                          </div>
                        ))
                      ) : (
                        ...
                        {customerStats.recentOrders.map((order: any) => (
                          <div key={order.id} className="border rounded-lg p-4">
                            <div className="flex items-center justify-between mb-3">
                              <div>
                                <h3 className="font-semibold text-gray-900">{order.serviceDetails?.name || 'Service'}</h3>
                                <p className="text-sm text-gray-600">Order #{order.orderId}</p>
                              </div>
                              <Badge className={order.status === 'completed' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}>
                                {order.status}
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                              ...
                              <div>
                                ...
                                <p className="font-medium">{order.eventDate ? new Date(order.eventDate.toDate()).toLocaleDateString() : 'N/A'}</p>
                              </div>
                              <div>
                              ...
                              <div>
                                ...
                                <p className="font-medium">{order.createdAt ? new Date(order.createdAt.toDate()).toLocaleDateString() : 'N/A'}</p>
                              </div>
                            </div>
                          </div>
                        ))}
